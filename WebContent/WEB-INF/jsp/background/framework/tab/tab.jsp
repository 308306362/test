...
<body bgcolor="#353c44">
	<div>
		...
		<dir style="color: white; font-size: 20px;">
			...
			<span class="STYLE7"><b><SPAN id=clock
	...
	<div style="padding: 8px; background-color: gray;" align="center">
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			...
			<param name="movie"
				value="${pageContext.servletContext.contextPath }/js/20101262241501.swf" />
			<param name="quality" value="high" />
			<embed
				src="${pageContext.servletContext.contextPath }/js/20101262241501.swf"
				quality="high"
				pluginspage="http://www.macromedia.com/go/getflashplayer"
				type="application/x-shockwave-flash" width="690" height="200"></embed>
		</object>
